...
## Purpose
Recomendaciones de productos relacionados basados en analytics de órdenes y categoría del producto.
...
- Response time MUST be < 300ms for datasets up to 100 products
- Analytics query MUST use a single SQL query (raw or Prisma) to avoid N+1
- Results SHOULD be cacheable with TTL of 5 minutes
